...
namespace Aircompany
{
    public class Airport
    {
        ...
        public List<MilitaryPlane> TransportMilitaryPlanes => Planes.OfType<MilitaryPlane>().Where(plane => plane.Type == MilitaryType.TRANSPORT).ToList();
        public PassengerPlane PassengerPlaneWithMaxPassengersCapacity => PassengersPlanes.First(plane => plane.PassengersCapacity == PassengersPlanes.Max(plane => plane.PassengersCapacity));
