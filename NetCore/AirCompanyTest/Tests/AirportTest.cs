...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        public void AirportHasTransportMilitaryPlane()
        {
            ...
            Assert.IsNotNull(transportMilitaryPlanes.Find(plane => plane.Type == MilitaryType.TRANSPORT));
        }
        ...
        [Test]
        public void PlaneHasHigherMaxLoadCapacityThanPrevious()
        {
            Airport airport = new Airport(planes);
            List<Plane> planesSortedByMaxLoadCapacity = airport.SortByMaxLoadCapacity().Planes.ToList();
            List<Plane> expectedPlaneSortByMaxLoadCapacity = airport.Planes.OrderBy(p => p.MaxLoadCapacity).ToList();
            Assert.IsTrue(expectedPlaneSortByMaxLoadCapacity.SequenceEqual(planesSortedByMaxLoadCapacity));
        }
    }
}
